...
public class OrderService {
    ...
    public OrderResponse.FindAllByUserDTO findAllByUser(int userId) {
        List<Cart> cartsPS = cartJPARepository.findAllByUserId(userId);
         System.out.println("로그3: " +cartsPS);
        return new OrderResponse.FindAllByUserDTO(cartsPS);
    }
